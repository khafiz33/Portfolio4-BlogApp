  ...
  <section class="featured">
    <div class="container featured__container post">
      ...
      <div class="post__info">
        ...
        ?>
        <a class="category__button" href="<?= ROOT_URL ?>category-posts.php?id=<?= $featured['category_id'] ?>"><?= $category['title'] ?></a>
    ...
    <?php while ($post = mysqli_fetch_assoc($posts)) : ?>
      <article class="post">
        ...
        <div class="post__info">
          ...
          $category = mysqli_fetch_assoc($category_result);
          ?>
          <a class="category__button" href="<?= ROOT_URL ?>category-posts.php?id=<?= $post['category_id'] ?>"><?= $category['title'] ?></a>
